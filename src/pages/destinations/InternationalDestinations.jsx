    ...
    <div className="min-h-screen pt-20 pb-10 bg-gray-50">
        ...
        >
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="text-center px-4 max-w-4xl mx-auto">
              <div className="inline-block bg-orange/20 backdrop-blur-sm px-6 py-2 rounded-full mb-6">
              ...
              <p className="text-lg md:text-xl text-white/95 max-w-2xl mx-auto drop-shadow-lg font-poppins leading-relaxed">
                Discover world-class destinations across Asia and beyond with our expertly curated travel packages
              </p>
            </div>
          </div>
        </HeroSlider>
      ...
      <section className="w-full px-4 md:px-6 lg:px-8 py-8">
        <div className="text-center mb-8">
          <h2 className="text-3xl md:text-4xl font-season font-bold text-darkBlue mb-3">Select Your Destination</h2>
          <div className="w-20 h-1 bg-gradient-to-r from-orange to-teal mx-auto mb-4"></div>
          <p className="text-darkBlue/70 text-lg max-w-2xl mx-auto">Handpicked international packages tailored for unforgettable experiences</p>
        </div>
              ...
              >
                ...
                <div className="p-4">
                  <div className="flex items-center justify-between pt-3 border-t border-gray-100">
                    ...
                    <i className="fa-solid fa-plane-departure text-darkBlue/20 text-xl"></i>
                  </div>
                </div>
              </Link>
          ))}
